...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! no exports provided */function(e,o,s){"use strict";s.r(o);var t=s(/*! ./parts/tabs.js */"./src/parts/tabs.js"),n=s(/*! ./parts/calc.js */"./src/parts/calc.js"),r=s(/*! ./parts/slider.js */"./src/parts/slider.js"),u=s(/*! ./parts/timer.js */"./src/parts/timer.js"),d=s(/*! ./parts/modal.js */"./src/parts/modal.js"),c=s(/*! ./parts/form.js */"./src/parts/form.js");window.addEventListener("DOMContentLoaded",function(){Object(t.default)(),Object(u.default)(),Object(d.default)(),Object(c.default)(),Object(r.default)(),Object(n.default)()})},"./src/parts/calc.js":
/*!***************************!*\
  !*** ./src/parts/calc.js ***!
  \***************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),s.d(o,"default",function(){return t});s(/*! core-js/modules/es6.regexp.replace */"./node_modules/core-js/modules/es6.regexp.replace.js");function t(){var e=document.querySelectorAll(".counter-block-input")[0],o=document.querySelectorAll(".counter-block-input")[1],s=document.getElementById("select"),t=document.getElementById("total"),n=0,r=0,u=0;function d(){this.value=this.value.replace(/[^\d]/gi,"")}t.innerHTML=0,e.oninput=d,o.oninput=d;var c=function(){r=+o.value,n=+e.value,u=4e3*(r+n),""==o.value||""==e.value||0==e.value||0==o.value?t.innerHTML=0:t.innerHTML=u*s.options[s.selectedIndex].value};e.addEventListener("input",c),o.addEventListener("input",c),s.addEventListener("change",c)}},"./src/parts/form.js":
/*!***************************!*\
  !*** ./src/parts/form.js ***!
  \***************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),s.d(o,"default",function(){return t});s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js"),s(/*! core-js/modules/es6.regexp.replace */"./node_modules/core-js/modules/es6.regexp.replace.js");function t(){var e={loading:"Загрузка...",success:"Спасибо! Скоро мы с Вами свяжемся",failure:"Что-то пошло не так..."},o=document.querySelector(".main-form"),s=o.getElementsByTagName("input"),t=document.createElement("div");function n(o){o.addEventListener("submit",function(n){n.preventDefault(),o.appendChild(t),function(e){return new Promise(function(o,s){var t=new XMLHttpRequest;t.open("POST","server.php"),t.setRequestHeader("Content-type","application/x-www-form-urlencoded"),t.onreadystatechange=function(){t.readyState<4?o():4===t.readyState&&200==t.readyState?o():s()},t.send(e)})}(new FormData(o)).then(function(){return t.innerHTML=e.loading}).then(function(){return t.innerHTML=e.success}).catch(function(){return t.innerHTML=e.failure}).then(function(){for(var e=0;e<s.length;e++)s[e].value=""})})}t.classList.add("status"),s[0].addEventListener("input",function(){s[0].value=s[0].value.replace(/[^0-9+]/gi,"")}),n(o);var r=document.getElementById("form"),u=r.getElementsByTagName("input");u[1].addEventListener("input",function(){u[1].value=u[1].value.replace(/[^0-9+]/gi,"")}),n(r)}},"./src/parts/modal.js":
/*!****************************!*\
  !*** ./src/parts/modal.js ***!
  \****************************/
/*! exports provided: default */function(e,o,s){"use strict";function t(){var e=document.querySelector("body"),o=document.querySelector(".more"),s=document.querySelector(".overlay");e.addEventListener("click",function(e){var t=e.target;(t.classList.contains("description-btn")||t.classList.contains("more"))&&(s.style.display="block",o.classList.add("more-splash"),document.body.style.overlay="hidden"),t.classList.contains("popup-close")&&(s.style.display="none",o.classList.remove("more-splash"),document.body.style.overlay="",statusMessage.innerHTML="")})}s.r(o),s.d(o,"default",function(){return t})},"./src/parts/slider.js":
/*!*****************************!*\
  !*** ./src/parts/slider.js ***!
  \*****************************/
